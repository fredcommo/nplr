...
```{r, simpleExample, fig.align='center', fig.width=11}
...
```{r, comparePlots, fig.align='center', fig.width=11}
...
```{r, duplicates, fig.align='center', fig.width=11}
...
```{r, weightMethods, fig.align='center', fig.width=11}
